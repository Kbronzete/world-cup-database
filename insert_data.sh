...
#Restart ids from 1 instead to start at the sum from previous truncates
...
do
  ...
  then
    ...
    if [[ -z $WINNER_ID ]] #This team's id was not yet on the teams table
    then
    ...
    if [[ -z $OPPONENT_ID ]] #This team's id was not yet on the teams table
    then
